...
| Zork II | `https://github.com/historicalsource/zork2.git` rechecked on `master` at commit `3da9661098809788a99cef00f00c865c6c204f96`; no tags/releases observed | Observed `LICENSE` is MIT text with `Copyright (c) 2025 Microsoft`, but packaging, trademarks, marketing materials, and non-source assets require final review | DDEV-only draft package assembled from the documented patched source-built historical-header artifact; `zork2.z3` SHA-256 `10015c715e9226c491bbfe23e448df14e859a0d9f905afc4fe0c18d65d176019`, 92412 bytes, Release 63 / Serial 860811; temporary published detail/play/story/helper routes and dfrotz smoke passed; IFID/catalog/iFiction, full helper docs, screenshots/art, and export/import remain pending | Use original Craig-created artwork and package-local extras only; classify any selected historical reference/preservation materials under `docs/DEMO-CONTENT-RIGHTS.md` and avoid historical commercial assets unless item-level review supports inclusion; no feelies copied yet | Placeholder helper docs only; final how-to, hints, walkthrough, and walkthrough verification pending | Candidate only; DDEV package restored to draft, not in `_demo` |
