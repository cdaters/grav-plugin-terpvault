...
- Zork III has stronger scratch build/playback evidence and a DDEV-only candidate package, but still needs full walkthrough verification, export/import, IFID/catalog/iFiction decisions, host-side binary-delivery recheck, and final audit before bundled-demo review.
