...
| [Zork II](demo-candidates/ZORK-II.md) | `https://github.com/historicalsource/zork2.git` rechecked at commit `3da9661098809788a99cef00f00c865c6c204f96` on `master`; no tags/releases observed | Strong candidate basis if MIT source release and redistribution requirements are confirmed; preserve upstream MIT license text and attribution; historical packaging/assets remain classified separately under `docs/DEMO-CONTENT-RIGHTS.md` | DDEV-only draft package assembled from patched source-built historical-header artifact `zork2-release63-serial860811.z3`; DDEV story target `zork2.z3` has SHA-256 `10015c715e9226c491bbfe23e448df14e859a0d9f905afc4fe0c18d65d176019`, size 92412, Release 63 / Serial 860811; IFID `ZCODE-63-860811`, IFDB TUID/URL, IFWiki URL, and package-local `metadata.iFiction.xml` added; route/story/helper-doc/selected-feelie/art/screenshot checks and dfrotz smoke passed; export/import still pending | Z-machine DDEV draft package only; no `_demo` package yet | Package-local cover/small-cover/hero art and gameplay screenshots copied in DDEV; seven feelies copied in DDEV and classified as historical reference/preservation material, historical reference/preservation requiring caution, or likely commercial material requiring caution | Original how-to and progressive hints drafted; walkthrough draft exists but dfrotz transcript verification is pending | Candidate only; DDEV package restored to draft | Verify walkthrough transcript, export/import smoke, final audit, and approval before any `_demo` work |
