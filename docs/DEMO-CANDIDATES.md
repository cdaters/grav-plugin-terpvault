...
- Zork III has stronger scratch build/playback evidence, a DDEV-only candidate package, and complete-package export/import smoke coverage, but still needs full walkthrough verification, IFID/catalog/iFiction decisions, final route-delivery recheck, and final audit before bundled-demo review.
