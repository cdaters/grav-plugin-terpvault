...
- Do not add Zork II to `_demo` until license/provenance, playback behavior, the dfrotz walkthrough blocker, package-local original material review, historical reference/preservation material review, export/import audit, and final approval are complete.
