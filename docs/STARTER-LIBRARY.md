...
- Do not add Zork II to `_demo` until license/provenance, playback behavior, final helper docs, walkthrough verification, IFID/catalog/iFiction metadata, screenshots, package-local original materials, any historical reference/preservation materials, and export/import audit are complete.
