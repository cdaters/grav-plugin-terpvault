...
- `zork-i`: bundled demo package with verified source/provenance, package-local original materials, and selected historical reference/preservation feelies classified in package provenance; keep it audited and re-verify if the story file changes.
