...
- `zork-ii`: candidate only. A DDEV-only draft package was assembled on 2026-06-02 from the documented patched source-built historical-header artifact; route/story/helper-doc checks and dfrotz smoke passed, and the package was restored to draft. IFID/catalog/iFiction metadata, final helper docs, package-local original materials, any historical reference/preservation materials, export/import smoke, and package audit must be complete before bundling.
